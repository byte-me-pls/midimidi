...
namespace AdvancedPeopleSystem
{
    ...
    public class UIControllerDEMO : MonoBehaviour
    {
        ...
        public void HeadPanel_Select(bool v)
        {
            HideAllPanels();
            if (!v)
        ...
        public void HeadChange_Event(int index)
        {
            CharacterCustomization.SetElementByIndex(CharacterElementType.Head, index);
        }
        ...
        Dictionary<CharacterElementType, Image> selectedButtons = new Dictionary<CharacterElementType, Image>()
    {
        ...
        public void ToggleButtonHead(Image image)
        {
            toogleButton(CharacterElementType.Head, image);
        }
