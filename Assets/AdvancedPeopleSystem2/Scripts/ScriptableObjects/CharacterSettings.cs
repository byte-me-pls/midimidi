...
namespace AdvancedPeopleSystem
{
    ...
    public class CharacterSettings : ScriptableObject
    {
        ...
        [Space(20)]
        public List<CharacterElementsPreset> headPresets = new List<CharacterElementsPreset>();
        ...
        public List<CharacterElementsPreset> GetCharacterElementsPresets(CharacterElementType type)
        {
            switch (type)
            {
